  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <header className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-gray-100">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <nav className="hidden md:flex space-x-8">
            <Link href="#services" className="text-gray-600 hover:text-[#FF2B4C] transition-colors font-medium">
              서비스
            </Link>
            <Link href="#capabilities" className="text-gray-600 hover:text-[#FF2B4C] transition-colors font-medium">
              기술역량
            </Link>
            <Link href="#portfolio" className="text-gray-600 hover:text-[#FF2B4C] transition-colors font-medium">
              고객사례
            </Link>
            <Link href="#pricing" className="text-gray-600 hover:text-[#FF2B4C] transition-colors font-medium">
              견적문의
            </Link>
          </nav>
          <Button className="bg-[#232324] hover:bg-[#232324]/90 text-white shadow-lg" style={{ borderRadius: '50px' }}>
      ...
      <div className="fixed bottom-6 right-6 z-50">
        <Button
          size="lg"
          className="bg-[#FF2B4C] hover:bg-[#FF2B4C]/90 text-white shadow-2xl rounded-full px-6 py-3 animate-pulse"
        >
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <ScrollAnimation animation="fadeInLeft">
                <h1 className="text-5xl md:text-6xl font-bold mb-6 text-[#232324] leading-tight">
              ...
              <ScrollAnimation animation="fadeInLeft" delay={200}>
                <div className="flex flex-col sm:flex-row gap-4 mb-12">
                  <Button
                    size="lg"
                    className="bg-[#232324] hover:bg-[#232324]/90 text-white text-lg px-8 py-4 shadow-lg"
              ...
              <ScrollAnimation animation="fadeInUp" delay={400}>
                <div className="grid grid-cols-3 gap-6">
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#FF2B4C] mb-1">24/7</div>
                    <div className="text-sm text-gray-600">긴급 대응</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#2CB693] mb-1">10~15%</div>
                    <div className="text-sm text-gray-600">유지보수 요율</div>
                  </div>
                  <div className="text-center">
                    <div className="text-2xl font-bold text-[#232324] mb-1">One-Stop</div>
                    <div className="text-sm text-gray-600">통합 서비스</div>
                  </div>
                </div>
              </ScrollAnimation>
            </div>
              ...
              <div className="relative">
                <div className="relative w-full h-96 flex items-center justify-center">
                  ...
                  <div className="relative w-64 h-64">
                    <div className="absolute inset-0 bg-[#FF2B4C]/20 rounded-full blur-xl animate-pulse"></div>
                    <div className="absolute inset-4 bg-[#FF2B4C]/30 rounded-full blur-lg animate-pulse delay-75"></div>
                    <div className="absolute inset-8 bg-[#FF2B4C]/40 rounded-full blur-md animate-pulse delay-150"></div>
                    <div className="absolute inset-12 bg-[#FF2B4C] rounded-full shadow-2xl"></div>

                    {/* Floating Elements */}
                    <div className="absolute -top-4 -right-4 w-16 h-16 bg-[#FF2B4C] rounded-full opacity-80 animate-bounce flex items-center justify-center">
                      <Monitor className="w-8 h-8 text-white" />
                    </div>
                    <div className="absolute -bottom-6 -left-6 w-12 h-12 bg-[#2CB693] rounded-full opacity-80 animate-bounce delay-300 flex items-center justify-center">
                      <Database className="w-6 h-6 text-white" />
                    </div>
                    <div className="absolute top-1/2 -right-8 w-8 h-8 bg-[#232324] rounded-full opacity-80 animate-bounce delay-500 flex items-center justify-center">
        ...
        <div className="container mx-auto px-6">
          <ScrollAnimation animation="fadeInUp">
            <div className="text-center mb-16">
              <h2 className="text-4xl mb-6 text-gray-900" style={{ fontWeight: 500 }}>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div>
              <div className="space-y-8">
                ...
                <ScrollAnimation animation="fadeInLeft" delay={300}>
                  <div className="flex items-start space-x-4">
                    <div className="w-12 h-12 bg-[#2CB693]/10 rounded-full flex items-center justify-center flex-shrink-0">
                      <Users className="w-6 h-6 text-[#2CB693]" />
                    </div>
                    <div>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <ScrollAnimation animation="fadeInRight" delay={400}>
                <Card className="p-6 text-center border-[#2CB693]/20 bg-white/70 backdrop-blur-sm shadow-lg">
                  <div className="text-2xl font-bold text-[#2CB693] mb-2">500+</div>
            ...
            <ScrollAnimation animation="fadeInUp" delay={100}>
              <Card className="p-8 bg-white/70 backdrop-blur-sm border-0 shadow-xl hover:shadow-2xl transition-all duration-300 group">
                ...
                <div className="mt-6 pt-6 border-t">
                  <div className="text-sm text-gray-500">유지보수 요율</div>
              ...
              <Card className="p-8 bg-white border border-gray-200 shadow-lg rounded-2xl">
                <CardHeader className="px-0 pt-0 pb-6">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <span className="text-blue-500 text-sm font-medium">빠른 응답</span>
                  </div>
                ...
                <CardContent className="px-0 space-y-6">
                  <div className="space-y-4">
                    <div>
                      <label className="text-sm font-medium text-gray-900 mb-2 block">이름</label>
                      <Input 
                        placeholder="홍길동" 
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-900 mb-2 block">이메일</label>
                      <Input 
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-900 mb-2 block">전화번호</label>
                      <Input 
                    ...
                    <div>
                      <label className="text-sm font-medium text-gray-900 mb-2 block">문의내용</label>
                      <Textarea
        ...
        <div className="container mx-auto px-6 text-center relative z-10">
          <ScrollAnimation animation="fadeInUp">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button size="lg" className="bg-[#FF2B4C] text-white hover:bg-[#FF2B4C]/90 text-lg px-8 py-4 shadow-lg" style={{ borderRadius: '50px' }}>
              ...
              <Button
                size="lg"
                variant="outline"
                className="border-[#2CB693] text-[#2CB693] hover:bg-[#2CB693] hover:text-white text-lg px-8 py-4" style={{ borderRadius: '50px' }}
              >
      ...
      <footer className="bg-[#232324] text-white py-12">
        <div className="container mx-auto px-6">
          ...
          <div className="border-t border-gray-700 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-sm text-gray-400">&copy; 2024 DIT Solution. All rights reserved.</p>
